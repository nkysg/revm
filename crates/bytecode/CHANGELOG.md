...
## [8.1.0](https://github.com/nkysg/revm/compare/revm-bytecode-v8.0.0...revm-bytecode-v8.1.0) - 2026-01-31

### Added

- Implement EIP-7843 SLOTNUM opcode for Amsterdam ([#3340](https://github.com/nkysg/revm/pull/3340))
- Implement EIP-8024 for Amsterdam ([#3223](https://github.com/nkysg/revm/pull/3223))

### Fixed

- *(bytecode)* add padding for final opcode missing immediates ([#3338](https://github.com/nkysg/revm/pull/3338))
- *(bytecode)* improve analyze_legacy and stack tests ([#3335](https://github.com/nkysg/revm/pull/3335))
- the LOG[0-4] CREATE CREATE2 opcode can modify memory ([#3328](https://github.com/nkysg/revm/pull/3328))
- *(bytecode)* improve analyze_legacy padding for SWAPN/DUPN/EXCHANGE ([#3332](https://github.com/nkysg/revm/pull/3332))

### Other

- remove GPL mention and update gmp feature comments ([#3383](https://github.com/nkysg/revm/pull/3383))
- *(tests)* remove redundant clones in legacy analysis tests ([#3317](https://github.com/nkysg/revm/pull/3317))
