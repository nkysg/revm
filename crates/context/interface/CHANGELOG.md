...
## [15.0.0](https://github.com/nkysg/revm/compare/revm-context-interface-v14.0.0...revm-context-interface-v15.0.0) - 2026-01-31

### Added

- *(gas)* add tx_access_list_cost helper to GasParams ([#3349](https://github.com/nkysg/revm/pull/3349))
- Implement EIP-7843 SLOTNUM opcode for Amsterdam ([#3340](https://github.com/nkysg/revm/pull/3340))

### Fixed

- use provided code hash when setting account code ([#3324](https://github.com/nkysg/revm/pull/3324))

### Other

- remove GPL mention and update gmp feature comments ([#3383](https://github.com/nkysg/revm/pull/3383))
- mark journal entry functions as deprecated ([#3367](https://github.com/nkysg/revm/pull/3367))
